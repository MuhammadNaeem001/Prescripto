  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
        <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px sm:min-w-96 border rounded-xl text-[#5E5E5E] text-sm shadow-lg'>
           ...
           {
            state === 'Admin' ? <p>Doctor Login ? <span className='bg-[#5F6FFF] underline cursor-pointer' onClick={()=>setState('Doctor')}>Login Here</span></p>
            : <p>Admin Login <span className='bg-[#5F6FFF] underline cursor-pointer' onClick={()=>setState('Admin')}>Click Here ? </span></p>
           }
        </div>
    </form>
  )

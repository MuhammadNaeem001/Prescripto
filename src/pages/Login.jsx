      ...
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-lg'>
        ...
        {state === 'Sign Up' && (
          <div className='w-full'>
            ...
            <input
              className='border border-zinc-300 rounded w-full h-9 px-2 mt-1 text-sm focus:outline-none focus:ring-1 focus:ring-indigo-500'
              type='text'
        ...
        <button
          className='bg-[#5F6FFF] text-white w-full h-10 rounded-md text-base mt-2 hover:bg-[#4b55e3] transition-all'
        >
          {state === 'Sign Up' ? 'Create Account' : 'Login'}
        </button> 
